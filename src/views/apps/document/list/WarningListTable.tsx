...
const DocumentListTable = ({ tableData }: { tableData?: UsersType[] }) => {
  // States
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            ...
            <IconButton title='View' >
              <i className='tabler-arrows-maximize text-textSecondary' />
            </IconButton>
          </div>
        )
      }),
  ...
  return (
    <>
      <Card>
        <CardHeader title='Document List' className='pbe-4' />
