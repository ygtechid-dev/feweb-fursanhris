  ...
  return (
    ...
    >
      <div className='flex items-center justify-between plb-5 pli-6'>
        <Typography variant='h5'>Add New Resignation</Typography>
      ...
      <div>
        ...
        <Controller
          ...
          <AppReactDatepicker
            ...
            value=''
            customInput={<CustomTextField label='Resignation Date' fullWidth />}
          />
          <AppReactDatepicker
            selected={date}
            id='basic-input'
            ...
            placeholderText='Click to select a date'
            value=''
            customInput={<CustomTextField label='Last Working Day' fullWidth />}
          />
         {/* <CustomTextField
            label='Gift'
            fullWidth
