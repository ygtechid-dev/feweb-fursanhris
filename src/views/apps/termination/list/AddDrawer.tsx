  ...
  return (
    ...
    >
      <div className='flex items-center justify-between plb-5 pli-6'>
        <Typography variant='h5'>Add New Termination</Typography>
      ...
      <div>
        ...
        <Controller
          ...
          <CustomTextField
              ...
              >
                <MenuItem value='' >Select Employee</MenuItem>
                <MenuItem value='admin'>Test Termination</MenuItem>
                <MenuItem value='author'>Voluntary Termination</MenuItem>
              </CustomTextField>
          ...
          <AppReactDatepicker
            ...
            value=''
            customInput={<CustomTextField label='Notice Date' fullWidth />}
          />
          <AppReactDatepicker
            selected={date}
            id='basic-input'
            ...
            placeholderText='Click to select a date'
            value=''
            customInput={<CustomTextField label='Termination Date' fullWidth />}
          />
         {/* <CustomTextField
