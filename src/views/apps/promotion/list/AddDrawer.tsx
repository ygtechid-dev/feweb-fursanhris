  ...
  return (
    ...
    >
      <div className='flex items-center justify-between plb-5 pli-6'>
        <Typography variant='h5'>Add New Promotion</Typography>
        ...
        <Controller
          ...
          <CustomTextField
              ...
              >
                ...
                <MenuItem value='admin'>CEO</MenuItem>
                <MenuItem value='author'>Accountant</MenuItem>
                <MenuItem value='editor'>Finance</MenuItem>
              </CustomTextField>
          <CustomTextField
          ...
          <AppReactDatepicker
            ...
            value=''
            customInput={<CustomTextField label='Promotion Date' fullWidth />}
          />
         {/* <CustomTextField
